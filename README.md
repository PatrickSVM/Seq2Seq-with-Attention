...
The plot shows the attention weights and word alignments for the German example sentence "Natürlich sind wir mit der gegenwärtigen Situation in China nicht zufrieden" with model translation "Of course, we are not satisfied with the
